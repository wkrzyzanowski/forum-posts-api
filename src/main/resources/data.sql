-- SELECT 1;
INSERT INTO TOPICS(ID, UUID, AUTHOR_UUID, TITLE, CREATION_DATE, LAST_POST_DATE, IMPORTANT, ACTIVE, LIKES, DISLIKES)
VALUES (1, 'guid_topic_1', '795756fd-e6e3-4266-b8b1-95fa0d73418a', 'FIRST TOPIC', LOCALTIME(), LOCALTIME(), 0, 1, 0, 0),
       (2, 'guid_topic_2', '3b56a26b-b8b3-4ed8-9bf2-60c2b981213a', 'SECOND TOPIC', LOCALTIME(), LOCALTIME(), 0, 1, 0,
        0);
